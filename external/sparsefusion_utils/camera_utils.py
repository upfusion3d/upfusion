...
def get_interpolated_path(cameras: PerspectiveCameras, n=50, method='circle', theta_offset_max=0.0, flip_up=False):
    '''
    ...
    if method == 'circle':
        ...
        factor = -1.0 if flip_up else 1.0

        #@ Get R T
        up_vec = -normal * factor
