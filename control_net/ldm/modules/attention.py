...
from control_net.ldm.modules.diffusionmodules.util import checkpoint
from upsrt.renderer.rays import get_plucker_parameterization, get_grid_rays_gpu
...
class SLTQueryTransformer(nn.Module):
    """
    Transformer block for image-like data.
    First, project the input (aka embedding)
    and reshape to b, t, d.
